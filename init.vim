...
" Same as above, but with colored icons
...
" Sandwich vim, preferring this instead of using surround.vim
...
" Plugin to show git signs on gutter, we can now use vim-gitgutter
...
" Plugin to use line text objects, _ (underscore) - 'inner line'
...
let g:CtrlSpaceUseArrowsInTerm = 1  "Should the plugin use arrows and <Home>, <End>, <PageUp>, <PageDown> keys in a terminal Vim.
...
" This to test out and customize the colors in fzf floating window
"hi TestColor guifg=#00FF00 guibg=#FFFF00 ctermbg=NONE ctermfg=NONE cterm=NONE
"Example 1:
"let g:fzf_colors = { 'border': ['bg', 'TestColor'] }
"Example 2:
"let g:fzf_colors = {
"            \ 'fg':      ['fg', 'Normal'],
"            \ 'bg':      ['bg', 'Normal'],
...
let g:undotree_SetFocusWhenToggle = 1 "let undotree window get focus after opening undotree
